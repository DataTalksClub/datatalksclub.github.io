---
title: "Context: A conversation with EasyJet lead data scientist Ioannis Mesionis that covers career roots, team structure, project intake and prioritization, the end‑to‑end data‑product lifecycle (EDA, modeling, pilots, A/B tests, rollout), stakeholder engagement, estimation and cadence, communication and soft skills, and pragmatic MLOps/monitoring choices.

Core theme: Deliver measurable business impact by treating data science as a product — combine domain knowledge and stakeholder partnership with clear intake/DoD processes, iterative MVP experimentation, and lightweight engineering and monitoring practices so models move quickly, safely, and transparently from idea to production."
