...
- line: Have a wonderful rest of your day, Rachel, and to everyone else — see you
  ...
  time: '53:28'
  who: Alexey
context: 'Context: Cities are complex systems where transport, land use, public space
  and technology intersect; practitioners juggle short-term operations and long-term
  planning using streams of sensor, fare, and observational data while balancing livability,
  equity and privacy.

  Core narrative: A human-centered, data-driven approach to urban mobility—building
  robust, privacy-aware data pipelines that integrate real-time sensors, fare systems
  and observational sources, and leveraging predictive models and generative-AI interfaces—enables
  actionable insights for both operational responsiveness and strategic planning,
  ultimately shaping walkable, equitable, and livable cities through transparent open
  data, rigorous data quality, and interdisciplinary collaboration.'
resources:
- name: Apache Kafka
  type: tool
  url: https://kafka.apache.org
  context: Used in transport data pipelines; covered in her course
- name: Apache Spark
  type: tool
  url: https://spark.apache.org
  context: Processes fare card and GPS data before warehousing
- name: data.gov.sg
  type: other
  url: https://data.gov.sg
  context: Singapore government open data portal across many domains
- name: DataMall
  type: other
  url: https://datamall.lta.gov.sg
  context: Portal with real-time taxi availability and parking datasets
- name: NYC Taxi Trip Record Data
  type: dataset
  url: https://www.nyc.gov/site/tlc/about/trip-record-data.page
  context: Aggregated dataset used in past data engineering courses
- name: The Death and Life of Great American Cities
  type: book
  context: Jane Jacobs classic critiquing traditional urban planning
- name: 'Happy City: Transforming Our Lives Through Urban Design'
  type: book
  context: Charles Montgomery book on urban design and happiness
- name: ChatGPT
  type: service
  url: https://chatgpt.com
  context: Voice assistant example of conversational interfaces
- name: World Cities Summit
  type: community
  url: https://www.worldcitiesummit.com.sg
  context: Conference that sparked her interest in urban planning
- name: Centre for Liveable Cities
  type: company
  url: https://www.clc.gov.sg
  context: Where she interned, deepening her sustainable cities focus
- name: Sam Schwartz
  type: company
  context: Transport consultancy firm where transport scientists work
---
Links:
