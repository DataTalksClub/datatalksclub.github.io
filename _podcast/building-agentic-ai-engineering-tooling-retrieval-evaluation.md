...
- line: Thanks a lot. We’ll see you soon in our next events.
  ...
  time: '59:23'
  who: Alexey
context: 'Context: The episode traces a practitioner’s journey from early ML and language
  work into building agentic systems for real-world SRE and productivity problems—covering
  definitions, architectures, planning, retrieval, tooling, frameworks, testing, and
  evaluation.
