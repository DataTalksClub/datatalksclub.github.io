...
description: 'Discover interpretable machine learning: learn SHAP, Conformal Prediction,
  calibrated uncertainty and model trust to debug models and boost reliability.'
