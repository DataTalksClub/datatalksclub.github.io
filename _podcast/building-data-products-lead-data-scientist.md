...
intro: How do you prioritize data product work, validate models in production, and
  keep them monitored without overwhelming stakeholders? In this episode, Ioannis
  Mesionis, Lead Data Scientist at easyJet and head of their MLOps efforts, walks
  through a practical data product operating model for tackling those challenges.
  <br><br> Drawing on his cross‑functional work with Digital, Customer & Marketing,
  Ioannis explains a four‑phase funnel with a "single front door" intake, a Definition
  of Done template with KPIs and fail‑fast checks, and an inception process that includes
  EDA and GDPR feasibility. He breaks down when to treat work as analytics vs. research,
  how R&D sprints and Kanban feed into pilot and A/B testing against baseline KPIs,
  and strategies for production rollout as MLOps capabilities evolve. Technical tooling
  and monitoring get concrete coverage — MLflow, Prefect/Airflow, and using Evidently
  for drift detection — plus pragmatic dashboarding and alerting patterns. Listeners
  will come away with actionable guidance on prioritization, designing A/B tests,
  model monitoring, stakeholder engagement, and the estimation and cadence practices
...
- name: easyJet
  ...
  context: Guest's airline employer; data products for digital marketing
- name: MLOps Zoomcamp
  type: course
  url: https://mlops.zoomcamp.com/
  context: Course guest took to learn the production ML side
- name: Evidently
  type: tool
  url: https://www.evidentlyai.com/
  context: Favorite Python library for model and data monitoring
- name: MLflow
  type: tool
  url: https://mlflow.org/
  context: Model tracking tool he already used at work
- name: Prefect
  type: tool
  url: https://www.prefect.io/
  context: Orchestration tool he explored through the course
- name: Apache Airflow
  type: tool
  url: https://airflow.apache.org/
  context: Orchestrator used by easyJet's data engineering team
- name: Cassie Kozyrkov
  type: person
  url: https://www.cassiekozyrkov.com/
  context: Decision intelligence advocate; model for explaining technical topics
- name: Making Friends with Machine Learning
  type: course
  context: Her YouTube course on communicating ML to non-technical audiences
- name: Pattern Recognition and Machine Learning
  type: book
  url: https://link.springer.com/book/10.1007/978-0-387-45597-7
  context: Heavy math textbook recommended for ML foundations
- name: Tableau
  type: tool
  url: https://www.tableau.com/
  context: Dashboards for insights and monitoring proof of concept
- name: Grafana
  type: tool
  url: https://grafana.com/
  context: Considered for monitoring UI before custom email alerts
- name: ChatGPT
  type: service
  url: https://chatgpt.com/
  context: Hack for simplifying technical explanations for non-technical people
- name: MLOps Summit
  type: community
  context: Conference where he presented easyJet's data science operating model
---
