...
- line: 50:32 Paid vs unpaid mentorship and finding the right fit
  ...
  time: '1:01:22'
  who: Alexey
context: 'Context: A physicist’s journey from building and analyzing massive collider
  experiments to applying those technical, collaborative, and software-engineering
  skills in industry—culminating in a deliberate turn toward mentoring others through
  career transitions and leadership challenges.

  Core theme: Experimental physics training—rooted in tackling large-scale data, complex
