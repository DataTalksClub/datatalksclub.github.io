...
**Q: What's the topic of today's episode?**
...
**Q: Before we dive in, could you tell us a bit about yourself and your perspective on this topic?**
...
**Q: So what are the different roles we typically find in a data team?**
...
**Q: Let's dive into the core responsibilities of each role. Could you give us an example to illustrate?**
...
**Q: Let's start with the product manager. What are their main responsibilities?**
...
**Q: Speaking of data analysts, what is their role in the team?**
...
**Q: What about data scientists? How do they differ from data analysts?**
...
**Q: And what about data engineers? What's their role?**
...
**Q: Are there other types of engineers in data teams?**
...
**Q: What about DevOps and Site Reliability Engineers?**
...
**Q: What about MLOps engineers? How are they different?**
...
**Q: Can you summarize all these roles?**
...
**Q: How can data engineers support others?**
...
**Q: Are there different ways models can be deployed?**
...
**Q: What is the difference between machine learning engineers and data engineers in scaling out data science models?**
...
**Q: Should the team also have a business analyst sitting between the product manager and data teams?**
...
**Q: What communication or soft skills are required in different positions?**
...
**Q: What roles do you see dependent on the size of the team? For example, would you see a machine learning engineer in a small team or only later in development?**
...
**Q: Do data engineers work on big data?**
...
**Q: Is there a neat separation between full-stack machine learning developers and full-stack web developers?**
...
**Q: If in a rather small team there is no machine learning ops or DevOps engineer, who would most likely perform these tasks?**
