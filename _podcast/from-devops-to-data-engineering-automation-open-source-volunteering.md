...
- line: Thank you!
  ...
  time: '1:01:46'
  who: Agita
context: 'Context: The episode traces a journey from hands-on technical beginnings
  (trade school, web design, C++, DevOps, automation) through burnout and volunteering,
  into community management, open source, NGO founding, career coaching, and a lifestyle
  experiment (off-grid living), while exploring personality, team fit, product focus,
  and practical processes applied across corporate and nonprofit settings.

  Core: This episode centers on intentionally aligning technical skills, systems-thinking
  problem solving, and personal values—leveraging automation, community, and experimentation—to
  design a sustainable, impact-driven career and life that bridges corporate, volunteer,
  and personal worlds.

  Key themes: transferable problem-solving and automation; values-driven career design;
  community & open source as leverage; translating corporate processes to NGOs; personality
  and team-fit for role choice; experimentation in lifestyle and governance.'
resources:
- name: Versatile Data Kit
  type: tool
  url: https://github.com/vmware/versatile-data-kit
  context: VMware open-source project where the guest was community manager
- name: VMware
  type: company
  context: guest's open-source community manager employer; later laid off
- name: Erasmus+
  type: other
  url: https://erasmus-plus.ec.europa.eu/
  context: EU youth volunteering program central to the guest's career break
- name: Accenture
  type: company
  context: boot camp and first job automating file migrations
- name: Nokia
  type: company
  context: internship that ended; interns moved into DevOps
- name: Myers-Briggs Type Indicator (MBTI)
  type: other
  context: personality typing discussed for teams and NGO events
- name: C++
  type: tool
  context: guest's favorite language from the Accenture boot camp
- name: Python
  type: tool
  context: guest's first project language and automation scripting
- name: Java
  type: tool
  context: language the guest tried learning but found too difficult
- name: Ruby
  type: tool
  context: language the guest had to learn on the go at work
- name: Data Makers Fest
  type: community
  context: Porto conference where the host and guest first met
- name: Open Bulgaria
  type: other
  context: volunteer project building a website for foreigners in Bulgaria
- name: Align Your Career With Who You Are
  type: course
  context: career coaching course the guest facilitated for two years
- name: Networking Premium
  type: company
  context: co-working space where the guest worked as community manager
---
Links:
