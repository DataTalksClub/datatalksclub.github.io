...
- line: You too. Thanks, everyone, for joining us today.
  ...
  time: '59:01'
  who: Alexey
context: 'Context — This episode moves from the guest’s finance-to-self-driving AI
  career and research in computer vision to concrete projects (AI Guide Dog, malaria
  mapping), deep dives on sensor and model tradeoffs (LiDAR vs cameras, on-vehicle
  inference, model compression), operational realities (data collection, labeling,
