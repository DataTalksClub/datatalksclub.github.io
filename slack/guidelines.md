...
* [Channels](#channels)
  ...
  * [Topic-specific channels](#topic-specific-channels)
* [Taking part in discussions](#taking-part-in-discussions)
  * [Thread best practices](#thread-best-practices)
  * [Additional discussion tips](#additional-discussion-tips)
* [Asking for help](#asking-for-help)
  * [Avoid meta questions](#avoid-meta-questions)
  * [Code problems and errors](#code-problems-and-errors)
  * [Homework help](#homework-help)
* [Promotion](#promotion)
  * [Where to promote](#where-to-promote)
  * [How to promote effectively](#how-to-promote-effectively)
  * [Frequency of posts](#frequency-of-posts)
  * [Surveys, product discovery, and feedback requests](#surveys-product-discovery-and-feedback-requests)
  * [Rules for vendors and company representatives](#rules-for-vendors-and-company-representatives)
  * [Unsolicited promotions in DMs](#unsolicited-promotions-in-dms)
  * [Non-relevant promotions](#non-relevant-promotions)
* [Jobs](#jobs)
  * [What to include in job posts](#what-to-include-in-job-posts)
  * [Position relevance](#position-relevance)
...
> **Note:** For detailed information about promoting your work, see the [Promotion section](#promotion) below.

### Topic-specific channels

These channels focus on specific areas of discussion. Use them to connect with people interested in the same topics:

* `#book-of-the-week` — Discuss books with book authors (check the [books page](https://datatalks.club/books.html) for more information)
...
> **Note:** This is not a complete list of channels. New channels may be created as the community grows. To see all available channels in Slack, you can browse them in the Slack sidebar or follow [these instructions](https://slack.com/intl/en-de/help/articles/205239967-Join-a-channel). 
...
* **Use threads**: [Threads](https://slack.com/help/articles/115000769927-Use-threads-to-organize-discussions-) help keep discussions organized and make it easier to follow conversations, especially in active channels.
...
**The golden rule:** [Don't ask to ask, just ask](https://dontasktoask.com/){:target="_blank"}. If you have a question, post it directly in the appropriate channel. The people who can help will see it and respond.
...
For more detailed guidance on asking homework questions effectively, consult [this excellent guide from StackOverflow](https://meta.stackoverflow.com/questions/334822/how-do-i-ask-and-answer-homework-questions).
...
To make sure the content you share is useful for community members, we ask you to follow our [shameless post templates](https://alexeygrigorev.notion.site/Shameless-channels-template-f565ac6aa2064f7190382f2ffd82c876). These templates help you provide context, explain why your content is relevant, and make your posts more valuable to readers.
